...
- **MrBayes**: Bayesian phylogenetic inference for individual gene families
  ...
  - Runs Bayesian MCMC analysis on nucleotide alignments
  - Converts output trees to Newick format
  - Generates mapping files for gene families
...
- `PPanggolin_msa_nt/`: Nucleotide alignments for persistent genes
- `PPanggolin_tree/`: FastTree phylogenetic tree
- `mrBayes/`: Bayesian phylogenetic trees for gene families